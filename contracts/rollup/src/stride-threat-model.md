...
| Repudiation            | `Repudiate.1` - The chain holds the commitment; the off-chain explorer holds the evidence. The root is immutable, and the block data that gives it meaning lives in a system the exchange can rewrite, so durability of the transparency claim rests on independent archival. |
...
**Did the STRIDE model uncover new design issues?** No.

**Did the treatments adequately address the issues?** N/A.

**Have additional issues been found after the threat model?** No.

**Anything to improve the process?** No.
