...
export const ContractError = {
  ...
  14: {message:"RenounceOwnershipDisabled"},
...
export class Client extends ContractClient {
  static async deploy<T = Client>(
        ...
        {xlm_token, yield_token, exchange, funding_partner, owner}: {xlm_token: string, yield_token: string, exchange: string, funding_partner: string, owner: string},
    ...
    return ContractClient.deploy({xlm_token, yield_token, exchange, funding_partner, owner}, options)
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
        ...
        "AAAAAAAAACpSZXR1cm5zIHRoZSB1cGdyYWRlLW9ubHkgZ292ZXJuYW5jZSBvd25lci4AAAAAAAVvd25lcgAAAAAAAAAAAAABAAAD6AAAABM=",
        ...
        "",
        ...
        "AAAAAAAAAGxSZWplY3RzIG93bmVyc2hpcCByZW51bmNpYXRpb24uCgojIEVycm9ycwoKKiBbYENvbnRyYWN0RXJyb3I6OlJlbm91bmNlT3duZXJzaGlwRGlzYWJsZWRgXSAtIEFsd2F5cyByZXR1cm5lZC4AAAAScmVub3VuY2Vfb3duZXJzaGlwAAAAAAAAAAAAAQAAA+kAAAPtAAAAAAAAB9AAAAANQ29udHJhY3RFcnJvcgAAAA==",
